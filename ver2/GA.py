...
def mutation(random_num):
    ...
    for _ in range(random_num):
        air_dB_start = random.randint(5, 14)
        air_dB_end = random.randint(air_dB_start, 14)
        ear_dB_start = random.randint(5, 14)
        ear_dB_end = random.randint(ear_dB_start, 14)
        throat_dB_start = random.randint(5, 14)
        throat_dB_end = random.randint(throat_dB_start, 14)
